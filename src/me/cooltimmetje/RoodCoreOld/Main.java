...
import me.cooltimmetje.RoodCore.CooldownList;
import me.cooltimmetje.RoodCore.CustomRecipes;
import me.cooltimmetje.RoodCore.GUIs.TimeCommandGUI;
import me.cooltimmetje.RoodCore.StaffPesten;
import me.cooltimmetje.RoodCore.XPStorage;
import me.cooltimmetje.RoodCoreOld.JoinSounds.ShopGUI;
import me.cooltimmetje.RoodCoreOld.Tokens.Tokens;
import me.cooltimmetje.RoodCoreOld.Tokens.TokensShop;
...
public class Main extends JavaPlugin{
    ...
    private static void getSettings(Player p, File userFile, FileConfiguration user) {
        ...
        if(!user.contains("joinsound")){
            user.set("joinsound", 0);
        } else {
            ShopGUI.joinSound.put(p.getName(), user.getInt("joinsound"));
        }
